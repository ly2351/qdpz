...
- 非常感谢各位开发者的点赞支持和关注（毕竟近6.9k的star，跪谢大家了！）
...
1.  下载安装：「HBuilderX」、「微信开发者工具」
2.  扫码登陆微信开发者工具
3.  将项目拖进【HBuilderX】- 运行 - 微信小程序 - 完成
...
> *  使用本框架不得用于开发违反国家有关政策的相关软件和应用，否则要负法律责任的哦！
...
<img src="https://cdn.zhoukaiwen.com/6qun-qdpz-0901.jpg" width="50%"/>
</p>
